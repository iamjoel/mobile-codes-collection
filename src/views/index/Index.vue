<template>
  <div class="main">
    ...
    <div class="ly ly-multi nav">
      <a href="javascript:void(0)" @click="$router.push('/list/infinate-load')" class="nav__item">
        <van-icon name="wap-nav" />
        <div class="mt-10 ta-c">无限加载</div>
      </a>
      <a href="javascript:void(0)" @click="$router.push('/list/no-data')" class="nav__item">
        <van-icon name="wap-nav" />
        <div class="mt-10 ta-c">无数据</div>
      </a>
      <a href="javascript:void(0)" @click="$router.push('/list/filter')" class="nav__item">
        <van-icon name="wap-nav" />
        <div class="mt-10 ta-c">搜索条件</div>
      </a>
      <a href="javascript:void(0)" @click="$router.push('/list/pull-refresh')" class="nav__item">
        <van-icon name="upgrade" />
        <div class="mt-10 ta-c">下拉刷新</div>
      </a>
      <a href="javascript:void(0)" @click="$router.push('/list/hor-scroll')" class="nav__item">
        <van-icon name="wap-nav" />
    ...
    <h2>图片</h2>
    <div class="ly ly-multi nav">
      <a href="javascript:void(0)" @click="$router.push('/img/lazyload')" class="nav__item">
        <van-icon name="photo" />
        <div class="mt-10 ta-c">懒加载</div>
      </a>
      <a href="javascript:void(0)" @click="$router.push('/img/img-preview')" class="nav__item">
        <van-icon name="photo" />
        <div class="mt-10 ta-c">图片预览</div>
      </a>
      <a href="javascript:void(0)" @click="$router.push('/img/img-badge')" class="nav__item">
        <van-icon name="photo" />
    ...
    <h2>其他</h2>
    <div class="ly ly-multi nav">
      <a href="javascript:void(0)" @click="$router.push('/data')" class="nav__item">
        <van-icon name="records" />
        <div class="mt-10 ta-c">数据获取</div>
      </a>
      <a href="javascript:void(0)" @click="$router.push('/media')" class="nav__item">
        <van-icon name="records" />
        <div class="mt-10 ta-c">Media</div>
      </a>
      <a href="javascript:void(0)" @click="$router.push('/form')" class="nav__item">
        <van-icon name="records" />
      ...
      <a href="javascript:void(0)" @click="$router.push('/map/120.614/31.3661/联青大厦/吴中东路134号')" class="nav__item">
        <van-icon name="records" />
