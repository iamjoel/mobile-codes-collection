  ...
  <div class="main">
    ...
    <van-swipe :autoplay="3000" style="height: 3rem;">
      <van-swipe-item v-for="i in 5" :key="i">
        <img :src="'http://via.placeholder.com/200x100?text=' + i" alt="" class="slide-img" />
      </van-swipe-item>
    </van-swipe>
    <div class="container">
      <h2 class="ly">
        ...
        <div class="like-wrap">
          <van-icon :name="hasStar ? 'like' : 'like-o'" @click="toggleStarStatus"/>
        </div>
      </h2>
        ...
        <van-tab  title="评价">
          <div class="review">
            <div class="review__item" v-for="i in 9" :key="i">
              <div class="ly">
                <img class="review__avater" :src="'http://via.placeholder.com/50x50?text=' + i" alt="">
                <div>
              ...
              <div class="review__detail">
                ...
                <div class="ly review__imgs">
                  <img :src="'http://via.placeholder.com/50x50?text=' + j" v-for="j in 7" class="review__img"">
                </div>
                <div class="review__time">{{new Date() | time('YYYY-MM-DD HH:mm:ss')}}</div>
    ...
    <van-goods-action>
      ...
      <van-goods-action-mini-btn icon="shopping-cart" @click="$router.push(`/page/mall/cart`)">
        购物车
      </van-goods-action-mini-btn>
