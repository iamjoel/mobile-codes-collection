  ...
  <div class="main">
    <div class="create">
        ...
        >
          ...
          >
          <a href="javascript:void(0)" class="remove-img-btn" @click="remove(i)"></a>
        </div>
    		...
    		<div class="img upload-img-btn-wrap" v-if="imgs.list.length < imgs.max">
    			...
    			<input 
            class="upload" type="file" accept="image/*" 
            @change="uploadImgs" :multiple="isIOS"
            ref="imgs"
          >
    		</div>
    	</div>
    ...
    <div class="confirm-button-wrap">
    	<a href="javascript:void(0)" class="primary-lg-btn" @click="save">发 布</a>
    </div>
  </div>
</template>
