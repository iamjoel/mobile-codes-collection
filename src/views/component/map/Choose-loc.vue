<template>
  <div class="main">
    <div class="ly ly-c p-20rem">
      <van-button type="primary" @click="isShowChooseLoc = true">选地址</van-button>
    </div>
    ...
    <van-popup 
        v-model="isShowChooseLoc"
        position="bottom"
      >
      <iframe style="height: 100vh" width="100%" height="100%" frameborder=0
        :src="mapUrl">
      </iframe>
    </van-popup>
  </div>
...
var mapUrl =  `https://apis.map.qq.com/tools/locpicker?search=1&type=1&key=${qqMapInfo.apiKey}&referer=${qqMapInfo.appName}`
