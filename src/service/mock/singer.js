...
Mock.mock(
  new RegExp(`${SERVER_PREFIX}/singer/list`),
  'get',
  ({ url, body }) => {
...
Mock.mock(
  new RegExp(`${SERVER_PREFIX}/singer/add`),
  'post',
  ({ url, body }) => {
...
Mock.mock(
  new RegExp(`${SERVER_PREFIX}/singer/detail`),
  'get',
  ({ url, body }) => {
    console.info(`Mock GET. URL: ${url}`)
...
Mock.mock(
  new RegExp(`${SERVER_PREFIX}/singer/edit`),
  'post',
  ({ url, body }) => {
    console.info(`Mock POST. URL: ${url}`)
...
Mock.mock(
  new RegExp(`${SERVER_PREFIX}/singer/del`),
  'post',
  ({ url, body }) => {
    console.info(`Mock POST. URL: ${url}`)
